    ...
    if (cardinality == 2) {
        if (mainthread) {
            int v1 = simplex_lambda[0] > tol ? 0 : simplex_lambda[1] > tol ? 1 : simplex_lambda[2] > tol ? 2
                                                                                                         : 3;
            int v2 = simplex_lambda[3] > tol ? 3 : simplex_lambda[2] > tol ? 2 : simplex_lambda[1] > tol ? 1
                                                                                                         : 0;
            double u = dots[diff2vect_map[v1][4]][diff2vect_map[v1][v2]] / dots[diff2vect_map[v1][v2]][
                    diff2vect_map[v1][v2]];

            Eigen::Vector3d a = vertices1[simplex_left[0]] - vertices2[simplex_right[0]];
            Eigen::Vector3d b = vertices1[simplex_left[1]] - vertices2[simplex_right[1]];
            Eigen::Vector3d p = Eigen::Vector3d::Zero();
            Eigen::Vector3d ab = b - a;
            Eigen::Vector3d ap = p - a;
            simplex_lambda[0] = 1 - u;
            simplex_lambda[1] = u;
        }
    }
...
void mcd_cuda(std::vector<Eigen::Vector3d> &vertices1,
              ...
              Eigen::Vector3d &point2, double eps) {
